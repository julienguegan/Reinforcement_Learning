...
class QLearningAgent(ReinforcementAgent):
    ...
    def __init__(self, **args):
        ...
        self.Qvalues = util.Counter() # initialization of q_values counter
    ...
    def update(self, state, action, nextState, reward):
        ...
        """
        term_1 = (1 - self.alpha) * self.getQValue(state, action)
        
        if len(self.getLegalActions(nextState)) == 0:
            term_2 = reward
        else:
            term_2 = reward + self.discount * self.getValue(nextState)
        
        term_2 = self.alpha * term_2
        
        self.Qvalues[(state, action)] = term_1 + term_2
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def update(self, state, action, nextState, reward):
        ...
        for feature in features_list:
            self.weights[feature] += self.alpha * difference * features_list[feature]
